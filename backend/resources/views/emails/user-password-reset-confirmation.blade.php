...
<head>
    <meta charset="UTF-8">
    <title>Konfirmasi Reset Password Bank Soal Digital</title>
</head>
<body style="font-family: Arial, sans-serif; color: #0f172a; line-height: 1.6;">
    <h2 style="margin-bottom: 0.5rem;">Konfirmasi Reset Password Bank Soal Digital</h2>

    <p>Halo {{ $targetUserName }},</p>
    <p>Kami menerima permintaan reset password untuk akun Anda di Bank Soal Digital.</p>
